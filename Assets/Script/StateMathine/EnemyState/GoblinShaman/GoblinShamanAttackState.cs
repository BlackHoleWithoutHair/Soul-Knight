...
public class GoblinShamanAttackState : EnemyState
{
    ...
    public GoblinShamanAttackState(EnemyStateController controller) : base(controller) { }
    ...
    public override void GameUpdate()
    {
        ...
        if (Timer > 7)
        {
            m_Controller.SetOtherState(typeof(GoblinShamanIdleState));
            return;
        }
    }
