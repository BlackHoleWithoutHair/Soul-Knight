...
public class GoblinGuardAttackState : EnemyState
{
    ...
    public GoblinGuardAttackState(EnemyStateController controller) : base(controller) { }
    ...
    public override void GameUpdate()
    {
        ...
        if (Timer > 7)
        {
            m_Controller.SetOtherState(typeof(GoblinGuardIdleState));
            return;
        }
    }
