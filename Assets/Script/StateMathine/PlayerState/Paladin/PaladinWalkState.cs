...
public class PaladinWalkState : PlayerState
{
    private Vector2 dir;
    public PaladinWalkState(PlayerStateController controller) : base(controller)
    {
    ...
    protected override void StateUpdate()
    {
        ...
        if (ver == 0 && hor == 0)
        {
            m_Controller.SetOtherState(typeof(PaladinIdleState));
            return;
        }
        if (player.isLeft)
        {
